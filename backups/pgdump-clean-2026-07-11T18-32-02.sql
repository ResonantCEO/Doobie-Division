...
\restrict YTcViqy2Z0JSwjHtPPXtb2bYmtgis0IREFT52iSuDGgzZ7e8c2hlkinuSmoptlk
...
ALTER TABLE IF EXISTS ONLY public.user_activity_logs DROP CONSTRAINT IF EXISTS user_activity_logs_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.support_tickets DROP CONSTRAINT IF EXISTS support_tickets_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.support_tickets DROP CONSTRAINT IF EXISTS support_tickets_assigned_to_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.support_ticket_responses DROP CONSTRAINT IF EXISTS support_ticket_responses_ticket_id_support_tickets_id_fk;
ALTER TABLE IF EXISTS ONLY public.support_ticket_responses DROP CONSTRAINT IF EXISTS support_ticket_responses_created_by_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.promo_code_uses DROP CONSTRAINT IF EXISTS promo_code_uses_promo_code_id_promo_codes_id_fk;
...
ALTER TABLE IF EXISTS ONLY public.product_quantity_pricing DROP CONSTRAINT IF EXISTS product_quantity_pricing_product_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.orders DROP CONSTRAINT IF EXISTS orders_customer_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.orders DROP CONSTRAINT IF EXISTS orders_assigned_user_id_users_id_fk;
...
ALTER TABLE IF EXISTS ONLY public.inventory_logs DROP CONSTRAINT IF EXISTS inventory_logs_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.inventory_logs DROP CONSTRAINT IF EXISTS inventory_logs_product_id_products_id_fk;
DROP INDEX IF EXISTS public.idx_pqp_product_id;
...
DROP INDEX IF EXISTS public."IDX_product_sizes_product_id";
...
ALTER TABLE IF EXISTS ONLY public.support_ticket_responses DROP CONSTRAINT IF EXISTS support_ticket_responses_pkey;
ALTER TABLE IF EXISTS ONLY public.sessions DROP CONSTRAINT IF EXISTS sessions_pkey;
ALTER TABLE IF EXISTS ONLY public.promotional_ads DROP CONSTRAINT IF EXISTS promotional_ads_pkey;
ALTER TABLE IF EXISTS ONLY public.promotional_ads DROP CONSTRAINT IF EXISTS promotional_ads_discount_id_unique;
...
ALTER TABLE IF EXISTS ONLY public.promo_code_uses DROP CONSTRAINT IF EXISTS promo_code_uses_pkey;
...
ALTER TABLE IF EXISTS ONLY public.product_quantity_pricing DROP CONSTRAINT IF EXISTS product_quantity_pricing_pkey;
ALTER TABLE IF EXISTS ONLY public.price_templates DROP CONSTRAINT IF EXISTS price_templates_pkey;
...
ALTER TABLE IF EXISTS ONLY public.city_purchase_limits DROP CONSTRAINT IF EXISTS city_purchase_limits_pkey;
ALTER TABLE IF EXISTS ONLY public.city_purchase_limits DROP CONSTRAINT IF EXISTS city_purchase_limits_city_name_unique;
ALTER TABLE IF EXISTS ONLY public.categories DROP CONSTRAINT IF EXISTS categories_pkey;
ALTER TABLE IF EXISTS ONLY public.access_passwords DROP CONSTRAINT IF EXISTS access_passwords_pkey;
...
ALTER TABLE IF EXISTS public.support_ticket_responses ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.promotional_ads ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.promo_codes ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.promo_code_uses ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.products ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.product_sizes ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.product_quantity_pricing ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.price_templates ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.inventory_logs ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.discounts ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.city_purchase_limits ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.categories ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.access_passwords ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.support_ticket_responses_id_seq;
DROP TABLE IF EXISTS public.support_ticket_responses;
DROP TABLE IF EXISTS public.sessions;
DROP SEQUENCE IF EXISTS public.promotional_ads_id_seq;
DROP TABLE IF EXISTS public.promotional_ads;
DROP SEQUENCE IF EXISTS public.promo_codes_id_seq;
DROP TABLE IF EXISTS public.promo_codes;
DROP SEQUENCE IF EXISTS public.promo_code_uses_id_seq;
DROP TABLE IF EXISTS public.promo_code_uses;
DROP SEQUENCE IF EXISTS public.products_id_seq;
DROP TABLE IF EXISTS public.products;
DROP SEQUENCE IF EXISTS public.product_sizes_id_seq;
DROP TABLE IF EXISTS public.product_sizes;
DROP SEQUENCE IF EXISTS public.product_quantity_pricing_id_seq;
DROP TABLE IF EXISTS public.product_quantity_pricing;
DROP SEQUENCE IF EXISTS public.price_templates_id_seq;
DROP TABLE IF EXISTS public.price_templates;
...
DROP SEQUENCE IF EXISTS public.inventory_logs_id_seq;
...
DROP SEQUENCE IF EXISTS public.city_purchase_limits_id_seq;
DROP TABLE IF EXISTS public.city_purchase_limits;
DROP SEQUENCE IF EXISTS public.categories_id_seq;
DROP TABLE IF EXISTS public.categories;
DROP SEQUENCE IF EXISTS public.access_passwords_id_seq;
DROP TABLE IF EXISTS public.access_passwords;
...
\unrestrict YTcViqy2Z0JSwjHtPPXtb2bYmtgis0IREFT52iSuDGgzZ7e8c2hlkinuSmoptlk
