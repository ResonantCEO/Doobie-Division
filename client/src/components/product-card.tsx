...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div className="product-card-container h-full perspective-1000">
      ...
      >
        {/* Front of card */}
        <Card className="product-card-face product-card-front absolute inset-0 w-full h-full overflow-hidden bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 shadow-premium hover:shadow-premium-hover transition-all duration-500 ease-out flex flex-col backface-hidden transform hover:-translate-y-2">
          ...
          <CardContent className="p-2 sm:p-3 md:p-4 bg-white dark:bg-gray-900 flex flex-col flex-1">
            <div className="flex-1 text-center">
              ...
              {(product as any).company && (
                <p className="text-xs sm:text-sm font-medium text-orange-600 dark:text-orange-400 uppercase tracking-wide">{(product as any).company}</p>
              )}
              {product.category && (
        ...
        {/* Back of card */}
        <Card className="product-card-face product-card-back absolute inset-0 w-full h-full overflow-y-auto bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 shadow-premium hover:shadow-premium-hover transition-all duration-500 ease-out flex flex-col backface-hidden rotate-y-180 transform hover:-translate-y-2">
