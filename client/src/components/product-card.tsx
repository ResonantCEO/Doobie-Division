...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div className="product-card-container h-full perspective-1000">
      ...
      >
        {/* Front of card */}
        <Card className="product-card-face product-card-front absolute inset-0 w-full h-full overflow-hidden bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 shadow-premium hover:shadow-premium-hover transition-all duration-500 ease-out flex flex-col backface-hidden transform hover:-translate-y-2"></Card>
