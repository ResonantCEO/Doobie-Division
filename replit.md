...
### Object Storage
The application uses Replit Object Storage for secure photo uploads during user registration:

- **Service**: Google Cloud Storage via Replit's object storage integration  
- **Upload Flow**: Presigned URLs generated by backend, direct client-to-GCS upload via Uppy
