...
export class ObjectStorageService {
  ...
  // Supports HTTP Range requests so browsers can seek/stream video files.
  ...
  async getObjectEntityUploadURL(): Promise<{ uploadURL: string; objectPath: string }> {
    ...
    // The object path should match what getObjectEntityFile expects
  ...
  // Deletes an object entity from object storage by its /objects/<uuid> path.
  async deleteObjectEntity(objectPath: string): Promise<void> {
    ...
    try {
      ...
      console.error(`Failed to delete object ${objectPath}:`, err);
    }
  }
